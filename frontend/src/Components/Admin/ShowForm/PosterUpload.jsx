...
const PosterUpload = ({ formData, setFormData }) => {
  ...
  const ImageUploadField = ({ label, imageKey, imageValue }) => (
    <div>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <ImageUploadField label="Poster 1 (Main)" imageKey="poster" imageValue={formData.poster} />
        <ImageUploadField label="Poster 2 (Optional)" imageKey="poster2" imageValue={formData.poster2} />
      </div>
