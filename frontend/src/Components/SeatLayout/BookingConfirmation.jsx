...
import { CheckCircle, AlertCircle, Calendar, Clock, MapPin, Ticket, Shield, ChevronRight, IndianRupee } from 'lucide-react';
            ...
            <div className="rounded-[1.9rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))] p-6 shadow-[0_18px_45px_rgba(0,0,0,0.26)] backdrop-blur-sm">
              ...
              <div className="">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-red-400"><IndianRupee size={14} className="inline self-center" />{total.toFixed(2)}</span>
                </div>
              </div>
            </div>
