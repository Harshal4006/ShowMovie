const generateBookingPendingEmail = (data) => {
  const {
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #1a1d27; border-radius: 16px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 32px 24px; text-align: center;">
              ...
              <p style="margin: 8px 0 0; color: rgba(255,255,255,0.9); font-size: 16px;">Booking Pending</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px 24px 16px;">
              ...
              <p style="margin: 8px 0 0; color: #9ca3af; font-size: 15px; line-height: 1.6;">Your payment is currently being processed. Your booking will be confirmed once the payment is verified.</p>
            </td>
          </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.06);">
                          ...
                          <p style="margin: 4px 0 0; color: #f59e0b; font-size: 15px; font-weight: 600; font-family: monospace;">${bookingId}</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.06);">
                      ...
                      <tr>
                        <td style="padding: 16px 0 0;">
                          ...
                          <p style="margin: 4px 0 0; color: #f59e0b; font-size: 24px; font-weight: 700;">₹${Number(amount).toFixed(2)}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="padding: 0 24px 32px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: rgba(245,158,11,0.1); border-radius: 10px; border: 1px solid rgba(245,158,11,0.2);">
                <tr>
                  <td style="padding: 16px;">
                    <p style="margin: 0; color: #fbbf24; font-size: 14px; line-height: 1.6;">Your seats are reserved for the next 15 minutes. Please complete your payment to confirm the booking.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 0 24px 32px; text-align: center;">
              <a href="https://showmovie-frontend.vercel.app/my-booking" style="display: inline-block; background-color: #f59e0b; color: #0f1117; text-decoration: none; padding: 14px 32px; border-radius: 10px; font-size: 16px; font-weight: 600;">Check Booking Status</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #0f1117; padding: 24px; text-align: center; border-top: 1px solid rgba(255,255,255,0.06);">
              <p style="margin: 0 0 8px; color: #6b7280; font-size: 14px;">Need help? Contact us at <a href="mailto:support@showmovie.com" style="color: #f59e0b; text-decoration: none;">support@showmovie.com</a></p>
...
module.exports = generateBookingPendingEmail;
